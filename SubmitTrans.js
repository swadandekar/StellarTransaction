...
var sourceSecretKey = 'SB3IXC4ZAVHTAWQTE466DNL5GWQ5DNRLIJL75IDR6KDGDZPZPZYL3A45';
...
//'GDKZKYW5ZEQZJVYROJITXPDGNGGJZSEVMFHTLDZ6JSXPOP45DJBWFXVI';
var transaction;
...
(async function main() {
    try {
      ...
      const transaction = new StellarSdk.TransactionBuilder(account, { fee })
          // Add a payment operation to the transaction //.createAccount
          .addOperation(StellarSdk.Operation.payment({
            ...
            amount: '8.5', /// use startingBalance: while using create account
          }))
